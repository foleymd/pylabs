...
def main():
    ...
    if terminate == False: #performing calculations and resetting variables only if the program isn't terminating       
        degreesCel = fahToCel(degreesFah)
        inputErrorCount = 0
        goodInput = False
...
def milesToKm(miles): # Converts miles to km and prints output.
    km = miles * 1.6
    print('William,', miles, 'mile(s) is equal to', km, 'kilometer(s).')


def fahToCel(degreesFah): # Converts degrees Fahrenheit to Celsius and prints output.
    degreesCel = (degreesFah - 32) * (5/9)
    print('William,', degreesFah, 'degree(s) Fahrenheit is equal to', degreesCel, 'degree(s) Celsius.')

    
def galToLit(gallons): # Converts gallons to liters and prints output.
    liters = gallons * 3.9
    print('William,', gallons, 'gallon(s) is equal to', liters, 'liters(s).')

    
def poundsToKg(pounds): # Converts pounds to kilograms and prints output.
    kg = pounds * .45
    print('William,', pounds, 'pound(s) is equal to', kg, 'kilogram(s).')

    
def inchesToCm(inches): # Converts inches to centimeters and prints output. 
    cm = inches * 2.54
